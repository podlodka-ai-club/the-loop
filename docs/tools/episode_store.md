...
не сформировал ни одного учебного кандидата. Доставка независима от валидации знаний, feedback
памяти и последующей публикации наблюдений через `memory_store`.
...
запись не переписывается. Ошибка архива не блокирует независимую доставку feedback и кандидатов
валидатору.
